...
public class IllegalArgumentExceptionDialogFragment extends DialogFragment {
	
    public static IllegalArgumentExceptionDialogFragment newInstance(Bundle args) {
        IllegalArgumentExceptionDialogFragment frag = new IllegalArgumentExceptionDialogFragment();
