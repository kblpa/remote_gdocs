...
public class OAuthMessageSignerExceptionDialogFragment extends DialogFragment {
	
    public static OAuthMessageSignerExceptionDialogFragment newInstance(Bundle args) {
        OAuthMessageSignerExceptionDialogFragment frag = new OAuthMessageSignerExceptionDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        int body = R.string.oauth_message_signer_exception_error;
