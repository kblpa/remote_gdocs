...
public class OAuthNotAuthorizedExceptionDialogFragment extends DialogFragment {
	
    public static OAuthNotAuthorizedExceptionDialogFragment newInstance(Bundle args) {
        OAuthNotAuthorizedExceptionDialogFragment frag = new OAuthNotAuthorizedExceptionDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        int body = R.string.oauth_not_authorized_exception_error;
