...
public class Preferences extends PreferenceActivity implements OnPreferenceChangeListener {
	protected String ACCOUNTS_PREFERENCES = "gdocscontrol-accounts";
	protected String SETTINGS_PREFERENCES = "gdocscontrol-settings";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		deleteAccount.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			public boolean onPreferenceClick(Preference preference) {
				SharedPreferences accounts = getSharedPreferences("gdocscontrol-accounts", 0);
